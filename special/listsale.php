...
function querySale() {
  ...
  var saleDate1 = document.getElementById('saleDate1').value;
  var saleDate2 = document.getElementById('saleDate2').value;
  queryString = "prodName=" + prodName + "&prodPrice1=" + prodPrice1 + "&prodPrice2=" + prodPrice2;
  queryString += "&saleDate1=" + saleDate1 + "&saleDate2=" + saleDate2;
  xmlhttp.open("POST", "querysale.php", true);
...
<form>
  ...
  <table>
    ...
    <tr><td rowspan="2">By date: </td><td>From <input type="date" id="saleDate1"></td></tr>
    <tr><td>to <input type="date" id="saleDate2"></td></tr>
  </table>
<p><input type="button" value="Search" onClick="querySale()"/><span style="margin: 0 50px;"></span>
<?php
